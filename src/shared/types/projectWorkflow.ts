...
export type WorkspaceTab = 'overview' | 'setup' | 'scope-review' | 'matching' | 'estimate' | 'proposal';

export const WORKSPACE_TABS: WorkspaceTab[] = ['overview', 'setup', 'scope-review', 'matching', 'estimate', 'proposal'];
