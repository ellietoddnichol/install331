...
export function Settings() {
  ...
  async function loadAll() {
    ...
    setLoadError(null);
    try {
      const [data, status, runs, dbStatus, ih] = await Promise.all([
        api.getV1Settings(),
        ...
        <section className="ui-accent-card p-4 space-y-3">
          ...
          <dl className="grid gap-2 text-xs sm:grid-cols-2">
            <div className="flex justify-between gap-2 border-b border-slate-100 pb-1">
              <dt className="text-slate-500">Database driver</dt>
            ...
            <div className="flex justify-between gap-2 border-b border-slate-100 pb-1">
              <dt className="text-slate-500">Gemini</dt>
            ...
            <div className="flex justify-between gap-2 border-b border-slate-100 pb-1">
              <dt className="text-slate-500">Supabase service role</dt>
            ...
            <div className="flex justify-between gap-2 border-b border-slate-100 pb-1">
              ...
              <dd>{integrationHealth.passwordLogin ? 'enabled' : 'off'}</dd>
            </div>
            <div className="flex justify-between gap-2 border-b border-slate-100 pb-1">
