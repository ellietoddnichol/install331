...
export async function extractIntakeFromGemini(input: ExtractInput): Promise<GeminiExtractionResult> {
  ...
  const prompt = [
    ...
    input.sourceType === 'pdf' ? 'You are provided with the raw PDF file natively. Prioritize your visual understanding of the tables, matrices, and schedules in the PDF file over any provided text representations.' : '',
